...
from calibrationselectwindow import Ui_Form as Ui_CalibrationSelectWindow
...
class CalibrationSelectWindow(QWidget):
    ...
    def __init__(self, parent=None, on_back_callback=None, on_settings_callback=None, on_distortion_callback=None, on_perspective_callback=None):
    ...
    def update_camera_status(self):
        ...
        self.ui.bCOffset.setEnabled(mcu_detected and mcu_calibrated and has_geometric and has_scale)
    ...
    def on_offset_clicked(self):
        ...
        print("[LOG] Offset Calibration button pressed - no function yet")
